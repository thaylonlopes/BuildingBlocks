...
```bash
dotnet add package CommonHelpers.HealthCheck --version 0.0.1-beta.1
```

Ou através do Gerenciador de Pacotes do Visual Studio:

```powershell
Install-Package CommonHelpers.HealthCheck -Version 0.0.1-beta.1
```
