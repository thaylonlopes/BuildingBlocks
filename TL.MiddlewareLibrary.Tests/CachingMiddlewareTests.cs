...
namespace TL.MiddlewareLibrary.Tests
{
    public class CachingMiddlewareTests
    {
        ...
        public async Task InvokeAsync_WhenDifferentQueryStringProvided_ShouldNotReturnOtherQueryCache()
        {
            ...
            var context1 = CreateHttpContext("GET", "/api/produtos", "?categoria=eletronicos");
            var context2 = CreateHttpContext("GET", "/api/produtos", "?categoria=livros");
        ...
        [Fact]
        public async Task InvokeAsync_WhenPostMethodExecuted_ShouldBypassCacheAndCallNextDelegate()
        {
            var executionCount = 0;
        ...
        [Fact]
        public async Task InvokeAsync_WhenDownstreamReturnsNon2xxStatusCode_ShouldNotCacheResponse()
        {
            var executionCount = 0;
            RequestDelegate next = ctx =>
            {
            ...
            var context1 = CreateHttpContext("GET", "/api/erro");
            var context2 = CreateHttpContext("GET", "/api/erro");
