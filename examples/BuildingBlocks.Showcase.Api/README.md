...
> Projeto executável e vitrine técnica demonstrando a utilização prática e integrada dos pacotes da suíte **TL.BuildingBlocks** (`TL.BaseContracts`, `TL.HealthCheck`, `TL.InvokePrivate`) em ASP.NET Core (.NET 8 / .NET 9).
